...
/* 
	ANOTHER FLAW :
	DEALER SHOULD HAVE BEEN DEALT TWO CARDS (HIDDEN CARD AS WELL) PRIOR TO SIMULATION
	AND WE DO NOT ALLOW DOUBLE DOWN AFTER SPLIT
	AND WE DO NOT ALLOW DOUBLE SPLITTING
	WE SHOULD NOT FREE AND ALLOC PLAYER2 SO OFTEN
*/
